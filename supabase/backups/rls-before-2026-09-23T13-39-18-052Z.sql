-- RLS snapshot before patch — generated 2026-09-23T13:39:18.143Z
...
--   CHECK: (EXISTS ( SELECT 1
   FROM staff_profiles p
  WHERE ((p.id = auth.uid()) AND (p.role = ANY (ARRAY['STORE_MANAGER'::text, 'ADMIN'::text, 'MANAGEMENT'::text])) AND p.active)))
-- order_items :: authenticated insert order items :: INSERT to authenticated
--   USING: (none)
--   CHECK: true
...
--   USING: (id = auth.uid())
--   CHECK: (none)
-- staff_profiles :: staff read own store roster :: SELECT to authenticated
...
$function$
;
CREATE OR REPLACE FUNCTION public.create_customer_and_attach(p_visit_id text, p_name text, p_phone text, p_source text DEFAULT 'Walk-in'::text, p_area text DEFAULT NULL::text, p_budget text DEFAULT NULL::text, p_actor uuid DEFAULT NULL::uuid)
 RETURNS customers
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
$function$
;
CREATE OR REPLACE FUNCTION public.record_sale(p_visit_id text, p_bill_number text, p_visit_product_ids text[], p_actor uuid)
 RETURNS orders
 LANGUAGE plpgsql
 SET search_path TO 'public'
AS $function$
...
-- stores: DELETE to postgres | DELETE to authenticated | DELETE to service_role | DELETE to anon | INSERT to postgres | INSERT to anon | INSERT to authenticated | INSERT to service_role | MAINTAIN to authenticated | MAINTAIN to service_role | MAINTAIN to anon | MAINTAIN to postgres | REFERENCES to postgres | REFERENCES to authenticated | REFERENCES to service_role | REFERENCES to anon | SELECT to authenticated | SELECT to service_role | SELECT to anon | SELECT to postgres | TRIGGER to authenticated | TRIGGER to postgres | TRIGGER to anon | TRIGGER to service_role | TRUNCATE to service_role | TRUNCATE to postgres | TRUNCATE to anon | TRUNCATE to authenticated | UPDATE to postgres | UPDATE to authenticated | UPDATE to anon | UPDATE to service_role
-- suppliers: DELETE to anon | DELETE to service_role | DELETE to authenticated | DELETE to postgres | INSERT to postgres | INSERT to service_role | INSERT to authenticated | INSERT to anon | MAINTAIN to authenticated | MAINTAIN to postgres | MAINTAIN to anon | MAINTAIN to service_role | REFERENCES to postgres | REFERENCES to service_role | REFERENCES to authenticated | REFERENCES to anon | SELECT to postgres | SELECT to authenticated | SELECT to anon | SELECT to service_role | TRIGGER to authenticated | TRIGGER to service_role | TRIGGER to postgres | TRIGGER to anon | TRUNCATE to service_role | TRUNCATE to authenticated | TRUNCATE to postgres | TRUNCATE to anon | UPDATE to anon | UPDATE to service_role | UPDATE to authenticated | UPDATE to postgres
-- v_floor_team: DELETE to postgres | DELETE to anon | DELETE to authenticated | DELETE to service_role | INSERT to anon | INSERT to service_role | INSERT to postgres | INSERT to authenticated | MAINTAIN to postgres | MAINTAIN to anon | MAINTAIN to authenticated | MAINTAIN to service_role | REFERENCES to service_role | REFERENCES to authenticated | REFERENCES to anon | REFERENCES to postgres | SELECT to authenticated | SELECT to service_role | SELECT to anon | SELECT to postgres | TRIGGER to authenticated | TRIGGER to postgres | TRIGGER to anon | TRIGGER to service_role | TRUNCATE to postgres | TRUNCATE to authenticated | TRUNCATE to service_role | TRUNCATE to anon | UPDATE to authenticated | UPDATE to postgres | UPDATE to service_role | UPDATE to anon
-- v_salespeople: DELETE to anon | DELETE to postgres | DELETE to authenticated | DELETE to service_role | INSERT to postgres | INSERT to anon | INSERT to authenticated | INSERT to service_role | MAINTAIN to anon | MAINTAIN to service_role | MAINTAIN to authenticated | MAINTAIN to postgres | REFERENCES to anon | REFERENCES to authenticated | REFERENCES to postgres | REFERENCES to service_role | SELECT to authenticated | SELECT to anon | SELECT to postgres | SELECT to service_role | TRIGGER to service_role | TRIGGER to authenticated | TRIGGER to anon | TRIGGER to postgres | TRUNCATE to postgres | TRUNCATE to service_role | TRUNCATE to anon | TRUNCATE to authenticated | UPDATE to postgres | UPDATE to authenticated | UPDATE to anon | UPDATE to service_role
-- v_store_managers: DELETE to postgres | DELETE to anon | DELETE to authenticated | DELETE to service_role | INSERT to postgres | INSERT to service_role | INSERT to authenticated | INSERT to anon | MAINTAIN to authenticated | MAINTAIN to anon | MAINTAIN to service_role | MAINTAIN to postgres | REFERENCES to service_role | REFERENCES to postgres | REFERENCES to authenticated | REFERENCES to anon | SELECT to service_role | SELECT to postgres | SELECT to authenticated | SELECT to anon | TRIGGER to postgres | TRIGGER to service_role | TRIGGER to anon | TRIGGER to authenticated | TRUNCATE to service_role | TRUNCATE to authenticated | TRUNCATE to postgres | TRUNCATE to anon | UPDATE to anon | UPDATE to authenticated | UPDATE to postgres | UPDATE to service_role
-- visit_events: DELETE to postgres | DELETE to authenticated | DELETE to anon | DELETE to service_role | INSERT to service_role | INSERT to authenticated | INSERT to postgres | INSERT to anon | MAINTAIN to anon | MAINTAIN to service_role | MAINTAIN to authenticated | MAINTAIN to postgres | REFERENCES to anon | REFERENCES to authenticated | REFERENCES to service_role | REFERENCES to postgres | SELECT to authenticated | SELECT to service_role | SELECT to anon | SELECT to postgres | TRIGGER to postgres | TRIGGER to authenticated | TRIGGER to anon | TRIGGER to service_role | TRUNCATE to service_role | TRUNCATE to anon | TRUNCATE to postgres | TRUNCATE to authenticated | UPDATE to authenticated | UPDATE to anon | UPDATE to postgres | UPDATE to service_role
-- visit_products: DELETE to service_role | DELETE to anon | DELETE to postgres | DELETE to authenticated | INSERT to authenticated | INSERT to postgres | INSERT to anon | INSERT to service_role | MAINTAIN to service_role | MAINTAIN to postgres | MAINTAIN to anon | MAINTAIN to authenticated | REFERENCES to anon | REFERENCES to authenticated | REFERENCES to postgres | REFERENCES to service_role | SELECT to anon | SELECT to service_role | SELECT to postgres | SELECT to authenticated | TRIGGER to authenticated | TRIGGER to anon | TRIGGER to postgres | TRIGGER to service_role | TRUNCATE to postgres | TRUNCATE to anon | TRUNCATE to service_role | TRUNCATE to authenticated | UPDATE to postgres | UPDATE to authenticated | UPDATE to anon | UPDATE to service_role
-- visits: DELETE to postgres | DELETE to authenticated | DELETE to service_role | DELETE to anon | INSERT to service_role | INSERT to anon | INSERT to postgres | INSERT to authenticated | MAINTAIN to anon | MAINTAIN to authenticated | MAINTAIN to service_role | MAINTAIN to postgres | REFERENCES to service_role | REFERENCES to postgres | REFERENCES to authenticated | REFERENCES to anon | SELECT to service_role | SELECT to authenticated | SELECT to postgres | SELECT to anon | TRIGGER to anon | TRIGGER to postgres | TRIGGER to service_role | TRIGGER to authenticated | TRUNCATE to service_role | TRUNCATE to anon | TRUNCATE to authenticated | TRUNCATE to postgres | UPDATE to service_role | UPDATE to authenticated | UPDATE to postgres | UPDATE to anon

    ...
    <section id="top" className="mx-auto max-w-6xl px-4 pt-12 pb-10 sm:px-8 sm:pt-20 lg:pt-24">
      <div className="grid items-start gap-10 md:grid-cols-2 md:gap-12 lg:gap-16">
        ...
        <div className="reveal relative" style={{ "--d": "140ms" } as React.CSSProperties}>
          <div className="pointer-events-none absolute -top-6 -right-6 -z-10 size-40 rounded-full bg-gold/25 blur-xl" />
          <div className="pointer-events-none absolute -bottom-6 -left-6 -z-10 size-40 rounded-full bg-blush/40 blur-xl" />
          <div className="glass-panel zoom-frame rounded-[1.5rem] p-3 ring-1 ring-shadow backdrop-blur-lg">
            <BoutiqueImage
          ...
          <div className="glass-panel-strong absolute -bottom-6 left-4 flex items-center gap-3 rounded-2xl px-4 py-3 ring-1 ring-shadow backdrop-blur-md">
            <BoutiqueImage
